...
The goal is to provide an interactive and flexible framework for disease risk assessment and analysis.
...
For these datasets, the system:
- Asks relevant medical questions
- Processes user responses
- Predicts the associated disease outcome
